			...
			<div className="max-w-6xl md:ml-64 mx-auto px-4 md:px-6 lg:px-8">
				...
				{loading ? (
					...
					<div className="space-y-4">
						{orders.map((order) => (
							<Card key={order._id} className="bg-white border-slate-200 hover:shadow-lg transition-shadow">
											...
											<div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
												<div>
													<div className="flex items-center gap-3 mb-2">
														<span className="font-mono text-sm text-slate-500">{order.orderId}</span>
						...
						{viewingOrder && (
							<div className="space-y-6">
								...
								{isDownloadAvailable(viewingOrder) && (
									<div className="border-t border-slate-200 pt-4">
										<h4 className="font-medium text-slate-900 mb-3">Download Product</h4>
											...
											<div className="flex items-center justify-between">
												<div>
													...
													<p className="text-xs text-emerald-600">
														Download expires on {formatDate(viewingOrder.downloadExpiry!)}
													</p>
												</div>
												<Button
													className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600"
